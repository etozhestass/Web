...
public class UserRepositoryImpl implements UserRepository {
    ...
    public void save(User user, String passwordSha) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
            try (PreparedStatement statement = connection.prepareStatement("INSERT INTO `User` (`login`, `admin`, `passwordSha`, `creationTime`) VALUES (?, ?, ?, NOW())", Statement.RETURN_GENERATED_KEYS)) {
    ...
    @Override
    public void changeAdminStatus(long userId, boolean newValue) {
        try (Connection connection = DATA_SOURCE.getConnection()) {
